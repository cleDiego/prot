function initInterface() {
    ...
    $(document).ready(function () {
        ...
        include('title', 'head', 'Caixa de Trabalho', { charset: 'utf-8' });
        ...
        include('link', 'head', null, { href: 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css' });
        include('link', 'head', null, { href: 'https://cdn.datatables.net/1.13.2/css/jquery.dataTables.min.css' });
        include('link', 'head', null, { href: 'https://clediego.github.io/prot/main.css?v='+Date.now() });
